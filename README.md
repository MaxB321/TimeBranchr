...
If you distribute a modified version, you must also make the source code available under the same license.
...
The source code will remain available under the GPL-3.0 license.
