...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionDark_Mode_New = QAction(MainWindow)
        self.actionDark_Mode_New.setObjectName(u"actionDark_Mode_New")
        ...
        self.actionShow_Username_in_Window_Title = QAction(MainWindow)
        self.actionShow_Username_in_Window_Title.setObjectName(u"actionShow_Username_in_Window_Title")
        ...
        self.menuView.addAction(self.actionDark_Mode_New)
        self.menuView.addAction(self.actionShow_Subcategory_Totals)
        self.menuView.addAction(self.actionShow_Toolbar)
        self.menuView.addAction(self.actionShow_Username_in_Window_Title)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionDark_Mode_New.setText(QCoreApplication.translate("MainWindow", u"Dark Mode", None))
